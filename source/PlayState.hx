...
class PlayState extends MusicBeatState
{
	...
	var heavenSky:FlxTypedGroup<FlxSprite>;
	var heavenClouds:FlxTypedGroup<FlxSprite>;
				...
				case 'heaven1':
					{
						...
						var cloud:FlxSprite = new FlxSprite(-195, -115).loadGraphic(Paths.image('funkinHeaven/skyBG1'));
				...
				case 'heaven3':
					{
						...
						var cloud:FlxSprite = new FlxSprite(-495, -160).loadGraphic(Paths.image('funkinHeaven/skyBG2'));
						cloud.scrollFactor.set(0.1, 0.1);
						cloud.setGraphicSize(Std.int(cloud.width * 4.1));
						cloud.setGraphicSize(Std.int(cloud.height * 5.5));
						cloud.updateHitbox();
						add(cloud);
						
						heavenSky = new FlxTypedGroup<FlxSprite>();
						...
						for (i in 0...5)
						{
							var sky:FlxSprite = new FlxSprite(0, 0).loadGraphic(Paths.image('funkinHeaven/skyBG2'));
							sky.scrollFactor.set(0.1, 0.1);
						    //sky.setGraphicSize(Std.int(sky.width * 3));
						    //sky.setGraphicSize(Std.int(sky.height * 4.8));
							sky.visible = false;
							sky.updateHitbox();
						...
						heavenClouds = new FlxTypedGroup<FlxSprite>();
						if (FlxG.save.data.distractions)
						{
							add(heavenClouds);
						}
						...
						for (i in 0...5)
						{
							var clouds:FlxSprite = new FlxSprite(-255, -30).loadGraphic(Paths.image('funkinHeaven/skyBG22'));
							clouds.scrollFactor.set(0.2, 0.2);
						    clouds.setGraphicSize(Std.int(clouds.width * 4.1));
						    clouds.setGraphicSize(Std.int(clouds.height * 5.1));
				...
				case 'heaven4':
					{
						...
						var bg:FlxSprite = new FlxSprite(-195, -95).loadGraphic(Paths.image('funkinHeaven/skyBG3'));
						bg.scrollFactor.set(0.1, 0.1);
						bg.setGraphicSize(Std.int(bg.width * 3));
						bg.setGraphicSize(Std.int(bg.height * 4.8));
						bg.updateHitbox();
						add(bg);
						
						var cloud:FlxSprite = new FlxSprite(-295, 10).loadGraphic(Paths.image('funkinHeaven/skyBG22'));
						cloud.scrollFactor.set(0.1, 0.1);
						cloud.setGraphicSize(Std.int(cloud.width * 3));
						cloud.setGraphicSize(Std.int(cloud.height * 4.8));
						cloud.updateHitbox();
	...
	override function beatHit()
	{
		...
		if (curBeat % 8 == 7 && curSong == 'rhayeepo')
		{
			boyfriend.playAnim('hey', true);
		}
		
		
		if (curBeat == 120 && curSong == 'finale')
		{
			defaultCamZoom = 0.8;
			boyfriend = new Boyfriend(700, 300, 'riodasu');
			add(boyfriend);
		}
		
		if (curBeat == 196 && curSong == 'finale')
		{
			defaultCamZoom = 0.7;
		}
			
		if (curBeat == 200 && curSong == 'finale')
		{
			boyfriend = new Boyfriend(700, 300, 'bauker');
			add(boyfriend);
		}
		
		if (curBeat == 376 && curSong == 'finale')
		{
			defaultCamZoom = 0.8;
		}
		
		if (curBeat == 386 && curSong == 'finale')
		{
			boyfriend = new Boyfriend(700, 350, 'lihtronx');
			add(boyfriend);
		}
			
		if (curBeat == 434 && curSong == 'finale')
		{
			defaultCamZoom = 0.6;
			boyfriend = new Boyfriend(700, 0, 'lucho');
			add(boyfriend);
		}
			
		if (curBeat == 508 && curSong == 'finale')
		{
			defaultCamZoom = 0.8;
		}
			
		if (curBeat == 516 && curSong == 'finale')
		{
			boyfriend = new Boyfriend(700, 300, 'clean');
			add(boyfriend);
		}
