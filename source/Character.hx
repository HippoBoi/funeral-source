...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'coffin':
				frames = Paths.getSparrowAtlas('coffin','shared',true);
				animation.addByPrefix('idle', 'cofin idle', 24, false);
				animation.addByPrefix('singUP', 'cofin up', 24, false);
				animation.addByPrefix('singDOWN', 'cofin down', 24, false);
				animation.addByPrefix('singLEFT', 'cofin left', 24, false);
				animation.addByPrefix('singRIGHT', 'cofin right', 24, false);
